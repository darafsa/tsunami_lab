...
tsunami_lab::t_real tsunami_lab::setups::Supercritical1d::getHeight(t_real in_x,
                                                                    t_real) const
{
  if (in_x >= 0 && in_x <= 25){
...
tsunami_lab::t_real tsunami_lab::setups::Supercritical1d::getMomentumX(t_real in_x,
                                                                       t_real) const
{
  if (in_x >= 0 && in_x <= 25){
    return 0.18;
