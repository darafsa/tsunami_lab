 ...
 *
 * @section DESCRIPTION
 * Two-dimensional dam break problem with bathymetry.
 **/
#ifndef TSUNAMI_LAB_SETUPS_BATHYMETRY_2D_H
#define TSUNAMI_LAB_SETUPS_BATHYMETRY_2D_H
 ...
 **/
class tsunami_lab::setups::Bathymetry2d: public Setup {
	private:
	...
	public:
		...
		**/
		Bathymetry2d( real in_heightInner, real in_heightOuter, real in_radiusDam, real in_xMax, real in_yMax, real in_scaling );
